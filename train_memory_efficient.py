...
class MemoryEfficientTrainer:
    ...
    def preprocess_data(self, df):
        ...
        # Find label column - check for common label column names
        label_col = None
        for col in ['label', 'Label', 'attack_type', 'class', 'classification']:
            if col in df.columns:
                label_col = col
                break
        
        # If still not found, look for the first non-numeric column
    ...
    def train_model_efficient(self, X, y):
        ...
        # Convert label names to strings to avoid errors
